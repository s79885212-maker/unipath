...
window.UNIPATH.universities.push(
  {
    ...
    description:
      "The oldest university in the United States and one of the best-funded. For international applicants the decisive fact is financial: Harvard evaluates applications without regard to ability to pay and offers international students exactly the same need-based aid as U.S. students.",
    englishTaught: true,
    ...
    programNote:
      "Harvard College offers roughly 50 undergraduate concentrations across arts and humanities, social sciences, sciences and engineering. There is no undergraduate business major; economics and applied mathematics are the usual routes into business careers.",
    links: {
    ...
    admissions: {
      platforms: [
        ...
        "Printable paper forms also accepted",
      ],
      deadlines: [
        {
          ...
          conditions:
            "Not binding, but restricted: you may not apply early to other private US universities. SAT/ACT results are needed by the end of November. Decisions are released in mid-December.",
          status: "confirmed",
          source:
        ...
        },
        {
          ...
          binding: false,
          appliesTo: "First-year applicants",
          conditions: "Decisions are released at the end of March.",
          status: "confirmed",
          source:
            "https://college.harvard.edu/admissions/apply/application-timeline",
          verified: "2026-09-23",
        ...
        },
        {
          ...
          date: "1 November 2026",
          binding: false,
          appliesTo: "Early Action applicants asking for aid",
          conditions:
            "Submitting by this date gives aid information when decisions are released in mid-December.",
          status: "confirmed",
          source:
            "https://college.harvard.edu/admissions/apply/application-timeline",
          verified: "2026-09-23",
        ...
        {
          name: "Financial aid application — Regular Decision",
          kind: "aid",
          entryTerm: "Autumn",
          entryYear: "2027",
          dateISO: "2027-02-01",
          ...
          binding: false,
          appliesTo: "Regular Decision applicants asking for aid",
          conditions:
            "Aid information arrives in late March with the decision.",
          status: "confirmed",
          source:
            "https://college.harvard.edu/admissions/apply/application-timeline",
          verified: "2026-09-23",
      ...
      applicationFee: {
        ...
        waiver: "Fee waiver available on request",
      },
      documents: [
      ...
      recommendations:
        "Two teacher recommendations, plus the school counsellor / school report",
      essay:
        "Common Application personal essay plus five required Harvard short-answer questions",
      interview: null,
      notes: [],
    },
    english: {
    ...
    academics: {
      ...
      otherTests:
        "Where the SAT/ACT is genuinely inaccessible, Harvard states the requirement can be met with AP results, IB actual or predicted scores, GCSE/A-Level actual or predicted results, or national leaving-exam results or predictions.",
      internationalQualifications:
        "National leaving examinations, A-Levels and IB are explicitly accepted as evidence in place of the SAT/ACT when those tests are not accessible.",
    },
    costs: {
      breakdown: {
        tuition: 62226,
        billed: 91634,
        budget: 95134,
        budgetText: "$95,134–$100,134",
        includes:
          "tuition, fees, housing and food; the full budget adds books, personal expenses, health insurance and travel",
      },
      ...
      items: [
        ...
        {
          label: "Student health insurance (waivable if covered elsewhere)",
          amount: 4954,
        },
      ],
    ...
    scholarships: {
      fullRide: {
        ...
        renewable: true,
        competitiveness:
          "Admission is the hard part — aid is automatic once admitted and assessed as having need. Families earning under $100,000 with typical assets have a zero expected parent contribution.",
        howToApply:
          "Apply for financial aid alongside the admission application. There is no separate scholarship competition.",
    ...
    sources: [
      ...
      },
      {
        ...
        url: "https://college.harvard.edu/financial-aid/how-aid-works/cost-attendance",
      },
    ],
...

  {
    ...
    description:
      "The reference point for science and engineering education worldwide. MIT runs its own application portal rather than the Common Application, still requires the SAT or ACT, and meets 100% of demonstrated financial need.",
    englishTaught: true,
    languageOfInstruction: "English",
    programs: [
      "computer-science",
    ...
    programNote:
      "Undergraduate majors are numbered by course (Course 6 is EECS, Course 15 is Management). Management Science at Sloan is the undergraduate business route.",
    links: {
    ...
    admissions: {
      ...
      deadlines: [
        {
          ...
          appliesTo: "First-year applicants",
          conditions:
            "Not binding. MIT uses its own application portal, not the Common App. Required tests must be taken before 30 November.",
          status: "confirmed",
          source:
        ...
        },
        {
          ...
          binding: false,
          appliesTo: "First-year applicants",
          conditions: "Required tests must be taken before 31 December.",
          status: "confirmed",
          source:
            "https://mitadmissions.org/apply/firstyear/deadlines-requirements/",
          verified: "2026-09-23",
      ...
      recommendations:
        "Two teacher letters — MIT recommends one from a maths or science teacher and one from a humanities, social science or language teacher",
      essay:
        "MIT uses its own set of short essay responses rather than one long personal statement",
      interview:
        "You may be contacted for an interview with an MIT Educational Counselor. If MIT cannot offer you one, the interview is waived and the application is not disadvantaged.",
    ...
    costs: {
      breakdown: {
        ...
        budget: 92760,
        includes:
          "tuition, the student life fee, housing, food, books and personal expenses",
      },
      academicYear: "2026–2027",
      currency: "USD",
    ...
    scholarships: {
      fullRide: {
        ...
        renewable: true,
        competitiveness:
          "Aid is assessed, not competed for: every admitted student who applies for aid receives what their family is assessed to need. Families earning under $100,000 with typical assets have a $0 parental contribution; families under $200,000 have full tuition paid.",
        howToApply:
          "Apply for financial aid and complete the CSS Profile; you are then automatically considered for an MIT Scholarship.",
    ...
    sources: [
      {
        label: "First-year deadlines & requirements",
      ...
      {
        label: "Access and affordability (need-blind, full-need)",
        url: "https://mitadmissions.org/afford/cost-aid-basics/access-affordability/",
      },
    ],
...

  {
    ...
    description:
      "Yale is need-blind for every applicant in the world and meets 100% of demonstrated need without loans. From the 2026–27 entering class, families earning under $100,000 with typical assets are expected to pay nothing at all.",
    englishTaught: true,
    languageOfInstruction: "English",
    programs: [
      "economics",
    ...
    programNote:
      "Yale College offers about 80 undergraduate majors. There is no undergraduate business degree; Economics is the largest major and the usual route into business careers.",
    links: {
    ...
    admissions: {
      ...
      deadlines: [
        {
          ...
          appliesTo: "First-year applicants",
          conditions:
            "Not binding, but you may not apply Early Action or Early Decision elsewhere, with the exceptions Yale lists. Decisions come in mid-December, including possible deferral to Regular Decision.",
          status: "confirmed",
        ...
        },
        {
          ...
          appliesTo: "First-year applicants",
          conditions:
            "Decisions come in late March; admitted students reply by 1 May.",
          status: "confirmed",
          source: "https://admissions.yale.edu/timelines",
          verified: "2026-09-23",
          note: null,
      ...
      applicationFee: {
        ...
        waiverAvailableToInternational: null,
        waiver:
          "Yale does not issue its own fee waivers, but applying for free is straightforward through the eligibility criteria of your chosen application platform. U.S. military veterans and active-duty service members receive automatic waivers.",
      },
      documents: [
        "Application with essays",
        "School Report with official transcript covering all completed secondary school courses",
        "Mid-Year Report with first-marking-period senior grades",
      ],
      recommendations:
        "Three letters: two teachers in core academic subjects (languages, maths, sciences, social studies) plus one school counsellor or administrator",
    ...
    english: {
      ...
      duolingo: null,
      waiver:
        "Required only if you are a non-native English speaker graduating from a secondary school where English is not the language of instruction.",
    ...
    academics: {
      ...
      sat: {
        policy: "required",
        note: "Applicants self-report scores from the ACT or SAT.",
      },
      act: {
        policy: "required",
        note: "Applicants self-report scores from the ACT or SAT.",
    ...
    costs: {
      breakdown: {
        ...
        budget: 97985,
        includes:
          "tuition, the activity fee, housing, food, books and personal expenses; travel is estimated individually",
      },
      academicYear: "2026–2027",
      currency: "USD",
      ...
      items: [
        ...
        {
          label: "Travel",
          text: "Estimated individually — not a fixed figure",
        },
      ],
      billedSubtotal: null,
    ...
    scholarships: {
      fullRide: {
        ...
        renewable: true,
        competitiveness:
          "Not a competition — every admitted student with sufficient assessed need receives it. For students entering in 2026–27, families with typical assets and incomes under $100,000 have all expected costs eliminated.",
        howToApply:
          "Apply for financial aid with the admission application. There is no separate scholarship form.",
    ...
    sources: [
      {
        label: "Application instructions & requirements",
        url: "https://admissions.yale.edu/instructions",
      },
      {
        label: "Deadlines and application platforms",
        url: "https://admissions.yale.edu/timelines",
      },
      { label: "Cost of attendance", url: "https://finaid.yale.edu/coa" },
      {
        label: "International students",
        url: "https://admissions.yale.edu/international",
      },
      {
        label: "Affordability / need-based aid",
        url: "https://admissions.yale.edu/affordability",
      },
    ],
    lastVerified: "2026-09-18",
  },

  {
    ...
    description:
      "A large private university spread through Manhattan with one of the biggest international student populations in the United States. NYU states that first-year students admitted to the New York campus have 100% of demonstrated need met regardless of citizenship, provided they apply for aid on time.",
    englishTaught: true,
    languageOfInstruction: "English",
    programs: [
      "business",
    ...
    admissions: {
      ...
      deadlines: [
        ...
        },
        {
          ...
          binding: true,
          appliesTo: "First-year applicants",
          conditions: "Binding. CSS Profile for aid by 10 January.",
          status: "confirmed",
          source:
            "https://www.nyu.edu/admissions/undergraduate-admissions/how-to-apply/all-freshmen-applicants.html",
          verified: "2026-09-23",
        ...
        },
        {
          ...
          appliesTo: "First-year applicants",
          conditions:
            "Testing is optional for this cycle. CSS Profile for aid by 1 February.",
          status: "confirmed",
          source:
            "https://www.nyu.edu/admissions/undergraduate-admissions/how-to-apply/all-freshmen-applicants.html",
          verified: "2026-09-23",
      ...
      applicationFee: {
        ...
        currency: "USD",
        waiverAvailableToInternational: null,
        waiver: "Fee waivers available through the Common Application",
      },
      documents: [
        "Common Application",
      ...
      interview: null,
      notes: [
        "Deadlines above were published for the 2025–2026 application cycle; confirm the current cycle before applying.",
      ],
    },
    english: {
      ielts: {
        min: null,
        recommended: null,
        note: "IELTS Academic accepted; NYU publishes no minimum.",
      },
      toefl: {
        min: null,
        recommended: 100,
        note: "NYU states it has no minimum score, but that competitive applicants score 100 or above on the TOEFL iBT taken on or before 20 January 2026. For tests taken on or after 21 January 2026 under the revised scale, competitive applicants score 5 or above overall and in subscores.",
      },
      duolingo: {
        min: null,
        recommended: null,
        note: "Duolingo English Test accepted; NYU publishes no minimum.",
      },
      waiver:
        "You must submit English testing if English is not your first language, if you took coursework in another language (excluding world-language courses), if you took English Language Support coursework (ESL, ELL, IB English B), or if you were in a bilingual curriculum. Results must be less than two years old.",
    ...
    academics: {
      ...
      sat: {
        policy: "optional",
        note: "NYU was test-optional for the 2025–2026 application cycle for every school and programme.",
      },
      act: {
        policy: "optional",
        note: "NYU was test-optional for the 2025–2026 application cycle for every school and programme.",
    ...
    sources: [
      {
        ...
        url: "https://www.nyu.edu/admissions/undergraduate-admissions/how-to-apply/all-freshmen-applicants.html",
      },
      {
        label: "English language testing",
        url: "https://www.nyu.edu/admissions/undergraduate-admissions/how-to-apply/standardized-tests/english-language-testing.html",
      },
      {
        label: "Financial aid — first-year applicants",
      ...
      {
        label: "The NYU Promise",
        url: "https://www.nyu.edu/admissions/financial-aid-and-scholarships/applying-as-a-prospective-undergraduate-student/first-year-applicants/the-nyu-promise.html",
      },
      {
        label: "Nursing (BS), traditional 4-year",
...

  {
    ...
    description:
      "One of the strongest public research universities in the world, with top-ranked engineering, business and computer science. Be clear-eyed about the money: U-M states that international students on temporary visas are not eligible for financial aid and are expected to pay the full cost of attendance.",
    englishTaught: true,
    languageOfInstruction: "English",
    programs: [
      "business",
    ...
    links: {
      ...
      internationalAdmissions:
        "https://admissions.umich.edu/i-am/international-students",
      applicationPortal: "https://www.commonapp.org/",
      ...
      deadlines: [
        {
          ...
          binding: true,
          appliesTo: "First-year applicants",
          conditions: "Binding; decisions by 24 December.",
          status: "confirmed",
          source:
        ...
        },
        {
          ...
          binding: false,
          appliesTo: "First-year applicants",
          conditions: "Not binding; decisions by 29 January.",
          status: "confirmed",
          source:
            "https://admissions.umich.edu/apply/first-year-applicants/requirements-deadlines",
          verified: "2026-09-23",
    ...
    english: {
      ielts: {
        min: 7.0,
        recommended: null,
        note: "IELTS or IELTS Indicator in the 7.0 range, with section scores of 6.5 or above.",
      },
      toefl: {
        min: 100,
        recommended: null,
        note: "TOEFL iBT (including Home Edition) in the 100 range, with section scores of 23+ in listening and reading and 21+ in speaking and writing.",
      },
      duolingo: {
        min: null,
        recommended: null,
        note: "Not confirmed on the page consulted.",
      },
    ...
    academics: {
      ...
      sat: {
        policy: "optional",
        note: "U-M states an applicant will not be disadvantaged if they do not submit an ACT/SAT score.",
      },
      act: {
        policy: "optional",
        note: "U-M states an applicant will not be disadvantaged if they do not submit an ACT/SAT score.",
    ...
    sources: [
      {
        label: "Requirements & deadlines",
        url: "https://admissions.umich.edu/apply/first-year-applicants/requirements-deadlines",
      },
      {
        label: "Exams & visas (English requirements)",
        url: "https://admissions.umich.edu/apply/international-applicants/exams-visas",
      },
      {
        label: "International students",
        url: "https://admissions.umich.edu/i-am/international-students",
      },
      { label: "Costs", url: "https://admissions.umich.edu/costs-aid/costs" },
      {
        label: "School of Nursing — BSN first-year entry",
        url: "https://nursing.umich.edu/admissions-aid/admission-requirements/bachelor-science-nursing-bsn-first-year-entry",
      },
    ],
    lastVerified: "2026-09-18",
  },

  {
    ...
    description:
      "A very large public university with an unusually open admissions policy for a research institution — a 3.0 GPA meets the published academic requirement — plus automatic merit scholarship consideration for international students. A realistic option for strong-but-not-elite applicants.",
    englishTaught: true,
    languageOfInstruction: "English",
    programs: [
      "business",
    ...
    programNote:
      "ASU offers more than 350 undergraduate degree programmes across its campuses. Some programmes set higher admission or English requirements than the university minimum and may consider ACT/SAT scores. The Health & Medicine tag reflects the Nursing BSN at ASU's Edson College of Nursing and Health Innovation; medicine (MD) is graduate study in the United States.",
    links: {
    ...
    admissions: {
      ...
      deadlines: [
        {
          ...
          conditions:
            "ASU publishes this as the priority date for the following intake; the enrolment deposit follows on 1 December.",
          status: "confirmed",
          source: "https://admission.asu.edu/apply/international/first-year",
          verified: "2026-09-23",
          note: null,
        },
        {
          ...
          conditions: "Deposit date tied to the priority round.",
          status: "confirmed",
          source: "https://admission.asu.edu/apply/international/first-year",
          verified: "2026-09-23",
          note: null,
      ...
      interview: null,
      notes: [
        "The international non-resident application fee is $90 and is non-refundable ($75 for ASU Online programmes).",
        "ASU admits on a rolling basis rather than a single national deadline — check the current term deadline on the official page.",
      ],
    },
    english: {
      ielts: {
        min: 6.0,
        recommended: null,
        note: "Overall band score of at least 6.0 on the Academic test.",
      },
      toefl: {
        min: 61,
        recommended: null,
        note: "Minimum 61 on the TOEFL iBT for general-requirement programmes.",
      },
      duolingo: {
        min: 95,
        recommended: null,
        note: "General required score of 95 for undergraduate admission.",
      },
      waiver:
        "Completion of ASU's Global Launch English and academic preparation courses also satisfies the requirement.",
    ...
    academics: {
      gpa: {
        min: 3.0,
        scale: 4.0,
        note: 'International first-year students must have a 3.00 GPA ("B" or better, where A = 4.00) from secondary school.',
      },
      sat: {
        policy: "optional",
        note: "Not required university-wide, but some programmes may consider a minimum ACT or SAT score.",
      },
      act: {
        policy: "optional",
        note: "Not required university-wide, but some programmes may consider a minimum ACT or SAT score.",
    ...
    costs: {
      breakdown: {
        ...
        budget: 69906,
        includes:
          "base tuition, surcharges and college fees, housing and meals, books, travel, personal expenses, health insurance and the international student fee",
      },
      academicYear: "2026–2027",
      currency: "USD",
      ...
      merit: [
        {
          ...
          amount: null,
          eligibility:
            "International first-year and transfer F-1 students who demonstrate high academic achievement",
          deadline: null,
          application:
            "Automatic — you are considered when you apply for admission, with no separate application",
          renewable: null,
    ...
    sources: [
      {
        label: "International first-year student admission",
        url: "https://admission.asu.edu/apply/international/first-year",
      },
      {
        label: "English language proficiency admission",
        url: "https://admission.asu.edu/apply/international/undergrad/english-proficiency",
      },
      {
        label: "International student cost of college",
        url: "https://admission.asu.edu/cost-aid/international",
      },
      {
        label: "Nursing, BSN",
        url: "https://degrees.asu.edu/bachelors/major/ASU00/NUNURDBSN/nursing",
      },
    ],
    lastVerified: "2026-09-18",
  },

  {
    ...
    description:
      "The clearest published merit scholarship ladder of any large U.S. public university, and international students are on exactly the same table as out-of-state Americans. If you can score well on the ACT or SAT, this is one of the most predictable ways to cut U.S. tuition.",
    englishTaught: true,
    languageOfInstruction: "English",
    programs: [
      "business",
    ...
    links: {
      ...
      internationalAdmissions:
        "https://admissions.ua.edu/international/freshman/",
    ...
    admissions: {
      ...
      deadlines: [
        {
          name: "Priority deadline — summer and autumn 2027 entry",
          kind: "priority",
          entryTerm: "Autumn",
          entryYear: "2027",
          dateISO: "2026-12-04",
          ...
          binding: false,
          appliesTo: "First-year applicants, including international students",
          conditions:
            "Alabama states that the application and official score reports must arrive by this date for priority scholarship consideration; GPA is counted through the end of junior year. Later applicants are considered for scholarships only if funds remain.",
          status: "confirmed",
        ...
        },
        {
          ...
          binding: false,
          appliesTo: "Applicants for the spring semester",
        ...
        {
          name: "Automatic merit scholarship notification",
          kind: "scholarship",
          entryTerm: "Autumn",
          entryYear: "2027",
          date: "February 2027",
      ...
      interview: null,
      notes: [
        "Scholarship deadlines and admission deadlines are the same dates — miss them and you lose automatic scholarship consideration.",
      ],
    },
    english: {
      ielts: {
        min: null,
        recommended: null,
        note: "A writing sub-score of 6.0 or higher avoids being placed into English language support courses.",
      },
      toefl: {
        min: null,
        recommended: null,
    ...
    academics: {
      gpa: {
        min: 3.0,
        scale: 4.0,
        note: "UA considers applicants with a cumulative GPA of 3.0 on a 4.0 scale for admission.",
      },
      sat: {
        policy: "optional",
        note: "Not required for admission unless your GPA is below 3.0 (for 2027 entry) — but required to be considered for automatic merit scholarships.",
      },
      act: {
        policy: "optional",
        note: "Not required for admission unless your GPA is below 3.0 (for 2027 entry) — but required to be considered for automatic merit scholarships.",
    ...
    scholarships: {
      fullRide: {
        ...
        renewable: true,
        competitiveness:
          "Requires a 4.0+ GPA together with a 36 ACT or 1600 SAT — an extremely narrow band, but it is an automatic award rather than a competition: hit the numbers and you receive it.",
        howToApply:
          "Automatic. Apply for admission by the deadline and have official ACT/SAT scores sent by the testing agency.",
      ...
      merit: [
        {
          name: "Crimson Legends Scholarship",
          amount: "$6,000 per year",
          eligibility: "GPA 3.50+ with ACT 25–26 or SAT 1200–1250",
          deadline: "2 November (spring) / 4 December (summer & fall)",
          application: "Automatic with admission application",
          renewable: null,
          note: "Values are identical for out-of-state and international students.",
        },
        {
          name: "Capstone Scholarship",
          amount: "$8,000 per year",
          eligibility: "GPA 3.50+ with ACT 27 or SAT 1260–1290",
          deadline: "2 November (spring) / 4 December (summer & fall)",
          application: "Automatic with admission application",
          renewable: null,
          note: null,
        ...
        {
          name: "Collegiate Scholarship",
          amount: "$10,000 per year",
          eligibility: "GPA 3.50+ with ACT 28 or SAT 1300–1320",
          deadline: "2 November (spring) / 4 December (summer & fall)",
          application: "Automatic with admission application",
          renewable: null,
          note: null,
        ...
        {
          name: "Foundation in Excellence Scholarship",
          amount: "$15,000 per year",
          eligibility: "GPA 3.50+ with ACT 29 or SAT 1330–1350",
          deadline: "2 November (spring) / 4 December (summer & fall)",
          application: "Automatic with admission application",
          renewable: null,
          note: null,
        },
        {
          ...
          eligibility: "GPA 3.50+ with ACT 30–31 or SAT 1360–1410",
          deadline: "2 November (spring) / 4 December (summer & fall)",
          application: "Automatic with admission application",
          renewable: null,
          note: null,
        },
        {
          ...
          eligibility: "GPA 3.50+ with ACT 32–36 or SAT 1420–1600",
          deadline: "2 November (spring) / 4 December (summer & fall)",
          application: "Automatic with admission application",
          renewable: null,
          note: null,
        ...
        {
          name: "Presidential Elite Scholar",
          amount:
            "Value of tuition for up to 4 years, plus first-year housing, $1,500/year supplement and a $2,000 research/study-abroad allowance",
          eligibility: "GPA 4.0+ with ACT 36 or SAT 1600",
          deadline: "2 November (spring) / 4 December (summer & fall)",
          application: "Automatic with admission application",
          renewable: true,
          note: "The most valuable tier on UA's published table.",
        },
      ],
      needBased: {
    ...
    sources: [
      {
        label: "International freshman scholarships",
        url: "https://afford.ua.edu/scholarships/international/",
      },
      {
        label: "International freshman admissions",
        url: "https://admissions.ua.edu/international/freshman/",
      },
      {
        label: "English language proficiency policy",
        url: "https://admissions.ua.edu/international/english-language-proficiency/",
      },
      {
        label: "Capstone College of Nursing — BSN",
        url: "https://nursing.ua.edu/academics/undergraduate/bsn/",
      },
    ],
    lastVerified: "2026-09-18",
  },

  {
    ...
    description:
      "Berea charges no tuition to anyone and states it is the only U.S. college that funds 100% of its enrolled international students. Admitted international students receive aid covering tuition, housing, food and fees. The catch is scale: roughly forty new international students are admitted each year.",
    englishTaught: true,
    languageOfInstruction: "English",
    programs: [
      "business",
    ...
    programNote:
      "A small liberal arts college with around 30 undergraduate majors. Every student works a campus job as part of the Work College model.",
    links: {
      website: "https://www.berea.edu/",
      admissions: "https://www.berea.edu/admissions",
      internationalAdmissions:
        "https://www.berea.edu/admissions/admission-information/apply/checklist-items/international-faqs",
      applicationPortal:
        "https://www.berea.edu/admissions/admission-information/apply",
    ...
    admissions: {
      ...
      deadlines: [
        {
          name: "International application deadline",
          kind: "intake",
          entryTerm: "Autumn",
          entryYear: "2027",
          dateISO: "2026-11-30",
          ...
          conditions:
            "All parts of the application must arrive by this date; decisions are released no later than 31 March. Berea states that admitted international students receive aid covering 100% of tuition, housing, food and fees.",
          status: "confirmed",
          source:
            "https://www.berea.edu/admissions/admission-information/apply/checklist-items/international-faqs",
          verified: "2026-09-23",
      ...
      applicationFee: {
        ...
        waiverAvailableToInternational: null,
        waiver: null,
        note: "Berea does not charge an application fee",
      },
      documents: [
        "Secondary school transcript",
      ...
      interview: null,
      notes: [
        "Berea admits about 40 or fewer new international students each year, so competition for places is severe even though the aid is guaranteed.",
        "Admission is need-based in the opposite direction from most colleges: Berea admits students with limited financial resources.",
      ],
    },
    english: {
      ielts: null,
    ...
    costs: {
      breakdown: {
        tuition: 0,
        includes:
          "no student pays tuition; aid also covers housing, food and fees",
      },
      academicYear: null,
      currency: "USD",
      ...
      items: [
        ...
        {
          label: "Housing, food and fees (international students)",
          text: "Covered by aid and scholarships",
        },
        {
          label: "Enrolment deposit",
          amount: 2200,
          note: "One-off, payable on acceptance; can be used toward expenses across four years. Additional aid is available for students who cannot pay it.",
        },
        {
          label: "Personal expenses (student's own savings)",
          amount: 1000,
          note: "Berea asks international students to save about $1,000 per year toward personal costs",
        },
      ],
    ...
    scholarships: {
      fullRide: {
        ...
        renewable: true,
        competitiveness:
          "Guaranteed once admitted — but admission is the bottleneck, with about 40 or fewer new international students per year against applications from around the world.",
        howToApply:
          "Apply for admission; the funding follows admission automatically.",
      ...
      merit: [
        {
          ...
          deadline: null,
          application: "Automatic with admission",
          renewable: true,
          note: "Berea states this scholarship, combined with grants and scholarships, guarantees that a student will never pay tuition from personal income.",
        },
      ],
      needBased: {
        availableToInternational: true,
    ...
    sources: [
      {
        ...
        url: "https://www.berea.edu/student-financial-aid",
      },
      {
        label: "International applicant information",
        url: "https://www.berea.edu/admissions/admission-information/apply/checklist-items/international-faqs",
      },
      {
        label: "No Tuition Promise",
        url: "https://www.berea.edu/admissions/no-tuition-promise/",
      },
      {
        label: "Economics and Business — majors and minors",
        url: "https://www.berea.edu/academics/departments-programs/economics-and-business/eco-bus-majors-and-minors",
      },
    ],
    lastVerified: "2026-09-18",
  },
  {
    ...
    description:
      "The oldest campus of the University of California and the strongest public university in the country by most measures. Berkeley is unusual among elite US universities in ignoring SAT and ACT scores entirely — and equally unusual in offering international students almost no need-based aid.",
    englishTaught: true,
    languageOfInstruction: "English",
    programs: [
      "computer-science",
    ...
    links: {
      ...
      scholarships:
        "https://financialaid.berkeley.edu/types-of-aid-at-berkeley/scholarships/regents-and-chancellors-scholarship/international-student-scholarships/",
      financialAid:
    ...
    admissions: {
      ...
      deadlines: [
        ...
        {
          name: "Statement of Intent to Register",
          kind: "reply",
          entryTerm: "Autumn",
          entryYear: "2027",
          dateISO: "2027-05-01",
      ...
      applicationFee: {
        ...
        waiverAvailableToInternational: null,
        waiver:
          "International applicants pay $95 per campus; those already enrolled at a US institution may qualify for the $80 fee. UC does not describe fee waivers for international applicants.",
      },
      documents: [
      ...
      recommendations:
        "None — UC states you should not submit letters of recommendation with the application",
      essay: "Personal insight questions within the UC Application",
      interview:
        "No admission interview. The optional InitialView interview is only additional evidence.",
      notes: [
    ...
    english: {
      ielts: {
        min: 6.5,
        recommended: null,
        note: "IELTS 6.5 or better satisfies the requirement.",
      },
      toefl: {
        min: 90,
        recommended: null,
        note: "TOEFL 90 or better satisfies the requirement.",
      },
      duolingo: {
        min: 115,
        recommended: null,
        note: "Duolingo English Test 115 or better is accepted.",
      },
      waiver:
        "Three or more years of instruction in English satisfies the requirement. Mixed-language instruction does not count.",
    ...
    academics: {
      ...
      sat: {
        policy: "not-used",
        note: "Berkeley lists the SAT only as one way to evidence English proficiency, not as part of the admission decision.",
      },
      act: {
        policy: "not-used",
        note: "Listed only as evidence of English proficiency (ACT English and Language Arts 24+).",
      },
      otherTests:
        "International applicants must report external examination results such as IGCSE/GCSE, and must hold qualifications such as A-Levels, the French Baccalaureate, IGCSE or ATAR where their own curriculum requires them.",
      internationalQualifications:
        "You must finish secondary school and earn the certificate of completion that would admit you to a university in your own country.",
    },
    costs: {
      breakdown: {
        tuition: 57484,
        budget: 101598,
        includes:
          "tuition and fees including nonresident supplemental tuition, housing, meals, health insurance, books, personal expenses and transport",
      },
      academicYear: "2026–2027",
      currency: "USD",
    ...
    scholarships: {
      fullRide: {
        ...
        renewable: true,
        competitiveness:
          "Extremely narrow. The only Berkeley award that reaches the full cost of attendance for international students is the Swaniker Scholars Program, which requires nomination by ALX or African Leadership Academy.",
        howToApply:
          "You cannot apply directly — candidates must be nominated by ALX or ALA. All other admitted international students are automatically considered for the scholarships they are eligible for.",
      ...
      merit: [
        {
          ...
          amount:
            "A monetary award plus additional benefits; Berkeley does not publish the amount on the international scholarships page",
          eligibility:
            "Exceptional admitted students showing creativity, leadership, service and strong convictions",
          deadline: null,
          application:
            "All admitted international students are automatically considered",
          renewable: null,
          note: "Berkeley calls this its most prestigious undergraduate scholarship.",
        },
        {
          name: "Robinson International Scholars Program",
          amount:
            "Need-based scholarship for up to four years, plus full Regents' and Chancellor's benefits",
          eligibility:
            "International students who are refugees or stateless people from Sub-Saharan African and developing nations, or who graduated from secondary school in such a country",
          deadline: null,
          application: "Automatic consideration on admission",
          renewable: true,
          note: null,
        },
        {
          name: "International Leaders Scholarship at UC Berkeley",
          amount:
            "Financial assistance for up to four years, plus full Regents' and Chancellor's benefits",
          eligibility:
            "Talented international students showing academic excellence and leadership; priority for students resident in Peru",
          deadline: null,
          application: "Automatic consideration on admission",
          renewable: true,
          note: null,
        ...
        {
          name: "Swaniker Scholars Program at UC Berkeley",
          amount: "Up to the full cost of attendance for four years",
          eligibility:
            "Students from across the African continent who are ALX Pathway participants or African Leadership Academy graduates",
          deadline: null,
          application: "By nomination from ALX or ALA only",
          renewable: true,
          note: "Need-based, and includes the full Regents' and Chancellor's benefits.",
        },
      ],
      needBased: {
        availableToInternational: false,
    ...
    sources: [
      {
        label: "Requirements for international students",
        url: "https://admissions.berkeley.edu/requirements-for-international-students/",
      },
      {
        label: "Student budgets (cost of attendance)",
      ...
      },
      {
        ...
        url: "https://financialaid.berkeley.edu/apply-now/international-students/",
      },
      {
        label: "Scholarship opportunities for international students",
        url: "https://financialaid.berkeley.edu/types-of-aid-at-berkeley/scholarships/regents-and-chancellors-scholarship/international-student-scholarships/",
      },
      {
        label: "UC — applying for admission as an international applicant",
        url: "https://admission.universityofcalifornia.edu/admission-requirements/international-applicants/applying-for-admission/",
      },
      {
        label: "UC — dates and deadlines 2026–27 (fall 2027 entry)",
        url: "https://admission.universityofcalifornia.edu/how-to-apply/applying-as-a-first-year/dates-and-deadlines.html",
      },
      {
        label: "Legal Studies undergraduate program",
        url: "https://jsp-ls.berkeley.edu/legal-studies",
      },
    ],
    lastVerified: "2026-09-18",
  },

  {
    ...
    description:
      "A small, undergraduate-focused Ivy League university in New Jersey. Princeton applies exactly the same financial aid policy to international students as to Americans: admission is need-blind, every admitted student's full demonstrated need is met with grants, and there are no loans in aid packages.",
    englishTaught: true,
    languageOfInstruction: "English",
    programs: [
      "engineering",
    ...
    programNote:
      "Princeton has no business, law or medical school for undergraduates; economics and the School of Public and International Affairs are the usual routes towards those careers. Every undergraduate writes a senior thesis.",
    links: {
      website: "https://www.princeton.edu/",
      admissions: "https://admission.princeton.edu/apply",
      internationalAdmissions:
        "https://admission.princeton.edu/how-apply/international-students",
      applicationPortal: "https://www.commonapp.org/",
    ...
    admissions: {
      ...
      deadlines: [
        {
          ...
          appliesTo: "First-year applicants",
          conditions:
            "A non-binding process: you may not apply to early programmes at other private US institutions. The graded written paper is due the same day; the optional arts supplement by 6 November. Decisions in mid-December.",
          status: "confirmed",
          source:
        ...
        },
        {
          ...
          appliesTo: "First-year applicants",
          conditions:
            "The graded written paper is due the same day; the optional arts supplement by 8 January. Decisions in late March.",
          status: "confirmed",
          source:
            "https://admission.princeton.edu/apply/first-year-application-dates-deadlines",
          verified: "2026-09-23",
        ...
        },
        {
          ...
          binding: false,
          appliesTo: "Admitted students",
          conditions: "Candidate response to accept the offer.",
          status: "confirmed",
          source:
            "https://admission.princeton.edu/apply/first-year-application-dates-deadlines",
          verified: "2026-09-23",
      ...
      applicationFee: {
        ...
        waiverAvailableToInternational: null,
        waiver:
          "Princeton offers its own fee waiver to low-income applicants and to anyone serving or who has served in the US military, with no counsellor approval needed. Waivers through the Common Application, ACT, College Board and NACAC are also accepted.",
      },
      documents: [
      ...
      recommendations:
        "Two teacher recommendations from core academic subjects, plus a counsellor recommendation",
      essay:
        "Common Application personal essay plus the Princeton-specific questions",
      interview: "An optional alumni interview may be offered",
      notes: ["Requesting a fee waiver does not disadvantage an application."],
    },
    english: {
      ielts: {
        min: null,
        recommended: null,
        note: "IELTS Academic is accepted, but Princeton does not publish a minimum score.",
      },
      toefl: {
        min: null,
        recommended: null,
        note: "TOEFL is accepted; no minimum score is published.",
      },
      duolingo: {
        min: null,
        recommended: null,
        note: "The Duolingo English Test is accepted; no minimum score is published.",
      },
      waiver:
        "No test is required if English is your native language, or if you have spent at least three years at a secondary school where English is the main language of instruction.",
    ...
    academics: {
      ...
      sat: {
        policy: "optional",
        note: "Test-optional for students entering in fall 2026 and fall 2027. Princeton has said testing will be required again for fall 2028 entry.",
      },
      act: {
        policy: "optional",
        note: "Same policy as the SAT: optional for fall 2026 and fall 2027 entry, required from fall 2028.",
      },
      otherTests: "SAT Subject Tests may be reported but are optional.",
      internationalQualifications:
        "Transcripts are assessed within the context of your own education system. School reports and recommendations may be in another language if officially translated — the graded written paper may not.",
    },
    costs: {
      breakdown: {
        tuition: 68140,
        billed: 90574,
        includes: "tuition, fees, housing and food (average)",
      },
      academicYear: "2026–2027",
      currency: "USD",
      ...
      items: [
        ...
        {
          label: "Average total of tuition, fees, housing and food",
          amount: 90574,
        },
      ...
      billedSubtotal: null,
      totalText:
        "$90,574 on average before aid — about $7,574 for students who receive aid",
    ...
    scholarships: {
      fullRide: {
        ...
        renewable: true,
        competitiveness:
          "Admission is the hard part. Once admitted, aid is assessed on need alone and is not a separate competition.",
        howToApply:
          "Apply for financial aid alongside the admission application — by 9 November for Single-Choice Early Action, or 1 February for Regular Decision.",
      ...
      needBased: {
        ...
        forms: [
          ...
          "CSS Profile or equivalent documentation",
        ],
        deadlines:
          "9 November for Single-Choice Early Action; 1 February for Regular Decision",
    ...
    sources: [
      {
        label: "Cost and aid",
        url: "https://admission.princeton.edu/cost-aid",
      },
      {
        label: "Application checklist",
        url: "https://admission.princeton.edu/apply/application-checklist",
      },
      {
        label: "First-year application dates and deadlines",
        url: "https://admission.princeton.edu/apply/first-year-application-dates-deadlines",
      },
      {
        label: "International students",
        url: "https://admission.princeton.edu/how-apply/international-students",
      },
    ],
    lastVerified: "2026-09-18",
  },
